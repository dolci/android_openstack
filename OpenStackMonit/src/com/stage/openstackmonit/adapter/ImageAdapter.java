...
public class ImageAdapter  extends ArrayAdapter<Image> {
	...
	List<Image> data;
	public ImageAdapter ( Context ctx, List<Image> objects) {
	 ...
	 class MyViewHolder
	    {
	        ...
	        MyViewHolder(View v)
	        {
	            ...
	            date= (TextView) v.findViewById(com.stage.openstackmonit.R.id.textView2);
	    ...
	    public View getView(final int position, View convertView, ViewGroup parent) {
	        ...
	        else
	        {
	         ...
	         holder.date.setText(data.get(position).getCreated());
